...
<div class="mb-8">
    ...
    <h1 class="text-4xl font-black uppercase tracking-tighter mt-4">Add Certificate</h1>
</div>

<form action="{{ route('admin.certificates.store') }}" method="POST" enctype="multipart/form-data" class="bg-white border-2 border-black p-6 md:p-8 rounded-lg shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] space-y-6">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2">
            ...
            <input type="text" name="issuing_organization" value="{{ old('issuing_organization') }}" class="w-full border-2 border-black p-3 focus:ring-0 focus:outline-none focus:border-primary transition" required>
        ...
        <div>
            ...
            <input type="text" name="issue_date" value="{{ old('issue_date') }}" placeholder="e.g. Jan 2025" class="w-full border-2 border-black p-3 focus:ring-0 focus:outline-none focus:border-primary transition" required>
        ...
        <div>
            ...
            <input type="text" name="expiration_date" value="{{ old('expiration_date') }}" placeholder="e.g. Jan 2028 (Leave blank if none)" class="w-full border-2 border-black p-3 focus:ring-0 focus:outline-none focus:border-primary transition">
        ...
        <div>
            ...
            <input type="text" name="credential_id" value="{{ old('credential_id') }}" class="w-full border-2 border-black p-3 focus:ring-0 focus:outline-none focus:border-primary transition">
        ...
        <div>
            ...
            <input type="url" name="credential_url" value="{{ old('credential_url') }}" class="w-full border-2 border-black p-3 focus:ring-0 focus:outline-none focus:border-primary transition">
